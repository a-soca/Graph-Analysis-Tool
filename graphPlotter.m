...
function [] = titleGenerator(lineType, a1, b1, c1) % this function generates a formatted title and live variable value display for the user
    ...
    fprintf(2, border,'            Graph Plotter', '           Alex Jones 2022'); % outputs line to console. fprintf is used rather than disp in this case to change the colour and add formatting
